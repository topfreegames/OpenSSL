...
DEFAULTTARGETS="ios-sim-cross-x86_64 ios-cross-armv7 ios-cross-armv7s ios64-cross-arm64 ios64-cross-arm64e"  # mac-catalyst-x86_64 is a valid target that is not in the DEFAULTTARGETS because it's incompatible with "ios-sim-cross-x86_64"
